    ...
    <div className="space-y-4">
      ...
      >
        {news.map((item) => (
          <div 
            key={item.id} 
            className="bg-card border border-border rounded-xl p-4 hover:border-blue-500/50 transition-all group min-w-[300px] max-w-[300px] snap-start flex flex-col justify-between"
          >
                ...
                <div className="space-y-2 flex-1">
                  ...
                  {item.aiSummary ? (
                    <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-3 mt-2 animate-in fade-in slide-in-from-left-2 duration-300">
                      ...
                      <p className="text-[11px] text-blue-100 italic leading-relaxed line-clamp-3">
                        "{item.aiSummary}"
                      </p>
                    </div>
                  ) : (
